                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Code</th><th>Name</th><th>Iso Code</th><th>Iso Name</th><th>ParentCode</th><th>ParentName</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($country as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->code }}</td><td>{{ $item->name }}</td><td>{{ $item->iso_code }}</td><td>{{ $item->iso_name }}</td><td>{{ $item->parentCode }}</td><td>{{ $item->parentName }}</td>
                                        <td>
                                            <a href="{{ url('/country/' . $item->id) }}" title="View Country"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/country/' . $item->id . '/edit') }}" title="Edit Country"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
