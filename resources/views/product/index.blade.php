                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Year</th><th>Month</th><th>Place</th><th>Output</th><th>Unit</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($product as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->year }}</td><td>{{ $item->month }}</td><td>{{ $item->place }}</td><td>{{ $item->output }}</td><td>{{ $item->unit }}</td>
                                        <td>
